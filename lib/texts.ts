...
export const texts = {
  ...
  modules: {
    ...
    offertenvergleich: {
      label: 'Offertenvergleich',
      description: 'Vergabeanalyse · Positionenvergleich · PDF-Report',
    },
    unternehmerliste: {
      label: 'Unternehmerliste',
      description: 'Kontaktverzeichnis · BKP / Unternehmer / Bauherrschaft',
    },
  },
  unternehmerliste: {
    bauherrTitle: 'Zuständige Personen der Bauherrschaft',
    bauherrAdd: '+ Person',
    entriesTitle: 'Unternehmer nach BKP',
    entryAdd: '+ BKP-Eintrag',
    contractorAdd: '+ Unternehmer',
    bkp: 'BKP',
    arbeitsgattung: 'Arbeitsgattung',
    firma: 'Firma',
    adresse: 'Adresse',
    ort: 'Ort',
    kontaktPerson: 'Zuständige Person',
    name: 'Name',
    funktion: 'Funktion',
    mail: 'E-Mail',
    telefon: 'Telefon',
    contractorsCount: 'Unternehmer',
    noEntries: 'Noch keine BKP-Einträge erfasst.',
    noBauherr: 'Noch keine Personen der Bauherrschaft erfasst.',
    noContractors: 'Noch kein Unternehmer erfasst.',
    confirmDeleteEntry: 'Diesen BKP-Eintrag mitsamt Unternehmern löschen?',
  ...
  hub: {
    ...
    subcategoryUngrouped: 'Ohne Unterkategorie',
  ...
  modal: {
    ...
    subcategoryPlaceholder: 'z.B. Grundrisse, Schnitte, Fassaden',
    subcategoryHint: 'Bestehende wählen oder neue eintippen.',
  ...
  admin: {
    ...
    kategorien: {
      ...
      allowSubcategories: 'Unterkategorien erlauben',
      fields: 'Feld-Schema',
      addField: '+ Feld',
      fieldLabel: 'Feldname',
  ...
  ov: {
    tagLabels: {
      kritisch: 'Kritisch',
      hot_spot: 'Hot Spot',
      plausibilitaet: 'Plausibilität prüfen',
      staerke: 'Stärke',
      hinweis: 'Hinweis',
    },
    status: {
    ...
    uebersicht: {
      countSuffix: 'Vergaben',
      countSuffixOne: 'Vergabe',
      colBkp: 'BKP',
      colTitel: 'Titel',
      colStatus: 'Status',
      colBieter: 'Bieter',
      colStand: 'Stand',
      empty: 'Noch keine Vergaben. Mit «Neue Vergabe» starten.',
      add: '+ Neue Vergabe',
      open: 'Öffnen',
    },
    neu: {
      title: 'Neue Vergabe',
      bkp: 'BKP',
      bkpPlaceholder: 'z.B. 271',
      titel: 'Titel',
      titelPlaceholder: 'z.B. Gipserarbeiten',
      lv: 'LV-Nummer (optional)',
      anlegen: 'Anlegen',
      fehler: 'Anlegen fehlgeschlagen – BKP bereits vorhanden?',
    },
    vergabe: {
      back: 'Übersicht',
      delete: 'Vergabe löschen',
      confirmDelete:
        'Vergabe mit allen Dokumenten und Auswertungen wirklich löschen?',
      dokumenteTitle: 'Dokumente',
      art: {
        positionenvergleich: 'Positionenvergleich',
        ausschreibung: 'Ausschreibung',
        offerte: 'Offerten',
        beilage: 'Beilagen',
      },
      artHint: {
        positionenvergleich: 'BauPlus-Export (PDF) – Grundlage der Analyse',
        ausschreibung:
          'Original-LV (PDF) – Referenz der Vollständigkeitsprüfung',
        offerte: 'Original-Offerten (PDF) – Vollständigkeitsprüfung und Kontrollsummen',
        beilage: 'Weitere Unterlagen',
      },
      gelesen: 'Gelesen',
      bieterZuordnung: 'Bieter:',
      bieterOhne: '– nicht zugeordnet –',
      ...
      bieterTitle: 'Bieter',
      kontrollsumme: 'Kontrollsumme (CHF)',
      kontrollsummeHint:
        'Endbetrag der Offerte vor Rabatt/Skonto/MwSt – Basis des Summen-Abgleichs.',
    },
    auswertung: {
      title: 'Auswertung',
      stand: 'Analyse vom',
      selbstpruefung: 'Selbstprüfungen',
      parserOk: 'Positionen vollständig gelesen',
      ...
      warnings: 'Parser-Hinweise',
      totalLabel: 'Positionssumme',
      rangPrefix: 'Rang',
      hotspotsTitle: 'Grosse Unterschiede',
      hotspotsHint:
        'Nach Kostenrelevanz sortiert · Grün günstigster, Orange teuerster · «Bericht» steuert die Aufnahme in den PDF-Report',
      colNpk: 'NPK',
      colBezeichnung: 'Bezeichnung',
      colWichtig: 'Bericht',
      blockTitle: 'Kostenblöcke',
      erkenntnisseTitle: 'Erkenntnisse',
      fazitTitle: 'Fazit',
      report: 'PDF-Bericht erstellen',
      reportRunning: 'Bericht wird erstellt …',
      reportDownload: 'Bericht öffnen',
      reportError: 'Bericht fehlgeschlagen',
      berichteTitle: 'Berichte',
      keineAuswertung:
    ...
    vollstaendigkeit: {
      ...
      start: 'Vollständigkeit prüfen',
      erneut: 'Vollständigkeit erneut prüfen',
      needsOfferte: 'Zuerst mindestens eine Offerte hochladen.',
      referenzAusschreibung: 'Referenz: Ausschreibung',
      referenzVergleich: 'Referenz: Positionenvergleich',
      stufen: {
        queued: 'Warteschlange …',
        extraktion: 'Dokumente lesen (KI) …',
        abgleich: 'Abgleich …',
        fortsetzung: 'Fortsetzung …',
        fertig: 'Fertig',
      },
      fortsetzungInfo: 'Grosse Dokumente werden in Etappen gelesen – die Prüfung setzt automatisch fort.',
      jobError: 'Vollständigkeitsprüfung fehlgeschlagen',
      keineAbweichungen: 'Keine Abweichungen – alle Offerten decken die Referenzliste vollständig ab.',
      nochNichtGeprueft: 'Noch nicht geprüft – Offerten hochladen und Prüfung starten.',
      typLabels: {
        fehlend: 'Fehlt',
      ...
      colDelta: 'Erwartet → Offerte',
      colBewertung: 'Bewertung',
      notizPlaceholder: 'Notiz …',
      erwartetPrefix: 'LV:',
      gefundenPrefix: 'Offerte:',
      abweichungenSuffix: 'Abweichungen',
      abweichungSuffixOne: 'Abweichung',
      stichprobe: 'Preis-Stichprobe',
      stichprobeOk: 'Stichprobe deckungsgleich mit der Matrix',
      hinweiseTitle: 'Lese-Hinweise',
      dokumentOhneBieter: 'Ohne Bieter-Zuordnung',
      bewertungHint:
        'Bewertungen und Notizen bleiben bei einer erneuten Prüfung erhalten. «Ignorieren» nimmt die Abweichung aus dem Bericht.',
    },
    report: {
      ...
      colCharakter: 'Charakter der Offerte',
      colTendenz: 'Tendenz',
      empfehlungTitle: 'Empfehlung der Bauleitung',
    },
  },
  tenantNotFound: {
